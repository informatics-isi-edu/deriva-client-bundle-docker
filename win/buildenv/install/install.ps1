...
.\python-3.5.4-amd64.exe /quiet TargetDir=c:\Python35 InstallAllUsers=1 PrependPath=1
...
.\Git-2.21.0-64-bit.exe  /VERYSILENT /SAVEINF=".\git.inf"
...
$env:path=$newPath
gci env:path
python -m pip install --upgrade pip setuptools wheel markdown
